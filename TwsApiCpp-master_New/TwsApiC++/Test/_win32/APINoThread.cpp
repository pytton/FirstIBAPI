...
int StartTWSConn()
{
	...
	tickerID = 2;
	pClientDIA->reqMktData(tickerID, diaContract, "", false);
	...
	tickerID = 3;
	pClientIWM->reqMktData(tickerID, iwmContract, "", false);
